    ...
    with app.app_context():
        new_channels = [
            ...
            {"channel": Channel(name='Leipziger Nachtwache', link='https://www.youtube.com/@leipzigernachtwache92800'),
             "owner": ["Ludwig"]},
            {"channel": Channel(name='Campus TV Bielefeld', link='https://www.youtube.com/@campustvbielefeld'),
             "owner": ''},
            {"channel": Channel(name='BR24', link='https://www.youtube.com/@BR24'),
             "owner": ''},
            {"channel": Channel(name='I am Jugger', link='https://www.youtube.com/@IamJugger'),
             "owner": ''},
            {"channel": Channel(name='NerdzigTV', link='https://www.youtube.com/@NerdzigTV'),
             "owner": ''},
            {"channel": Channel(name='Nikobewegtsich', link='https://www.youtube.com/@nikobewegtsich'),
             "owner": ''},
            {"channel": Channel(name='DER SPIEGEL', link='https://www.youtube.com/@derspiegel'),
             "owner": ''},
            {"channel": Channel(name='taff', link='https://www.youtube.com/@taff'),
             "owner": ''},
            {"channel": Channel(name='Wuppertaler Stadtwerke', link='https://www.youtube.com/@StadtwerkeWuppertal'),
             "owner": ''},
            {"channel": Channel(name='Cologne Raptors', link='https://www.youtube.com/@cologneraptors1476'),
             "owner": ''},
            {"channel": Channel(name='Suricatos Jugger', link='https://www.youtube.com/@suricatosjugger3035'),
             "owner": ''},
