...
new_users = [
    ...
    {"user": User(username='Max CH', email='testtest.de',
                  password_hash=generate_password_hash('test', method='scrypt')), "team": 'Jugger Basilisken Basel'},
    {"user": User(username='Jonas', email='testtest.de',
                  password_hash=generate_password_hash('test', method='scrypt')), "team": 'Flying Juggmen Bonn'},
    {"user": User(username='David GAG', email='testtest.de',
                  password_hash=generate_password_hash('test', method='scrypt')), "team": 'GAG'},
    {"user": User(username='David', email='testtest.de', password_hash=generate_password_hash('test', method='scrypt'))},
    ...
    {"user": User(username='Jules', email='testtest.de',
                  password_hash=generate_password_hash('test', method='scrypt')), "team": 'Schergen von Monasteria'},
    ...
    {"user": User(username='Simba', email='testtest.de',
                  password_hash=generate_password_hash('test', method='scrypt')), "team": 'Leipziger Nachtwache'},
    ...
    {"user": User(username='Nikolay', email='testtest.de',
                  password_hash=generate_password_hash('test', method='scrypt')), "team": 'die verstörten Zernichter'},
    {"user": User(username='Joni', email='testtest.de', password_hash=generate_password_hash('test', method='scrypt')), },
    {"user": User(username='Pete {}', email='testtest.de',
                  password_hash=generate_password_hash('test', method='scrypt')), "team": 'Die Leere Menge'},
    {"user": User(username='Ludwig', email='testtest.de',
                  password_hash=generate_password_hash('test', method='scrypt')), "team": 'Leipziger Nachtwache'},
    {"user": User(username='Yps', email='testtest.de', password_hash=generate_password_hash('test', method='scrypt')), },
    {"user": User(username='Luca', email='testtest.de',
                  password_hash=generate_password_hash('test', method='scrypt')), "team": 'MécanHydre'},
    {"user": User(username='Finn Eh', email='testtest.de', password_hash=generate_password_hash('test', method='scrypt')), },
    {"user": User(username='Manuel', email='testtest.de', password_hash=generate_password_hash('test', method='scrypt')), },
